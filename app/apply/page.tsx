    ...
    <main className="min-h-screen bg-[#224058] text-white">
      ...
      <header className="bg-[#224058] text-white border-b border-[#2d5170]">
        <div className="container mx-auto px-4 flex items-center justify-between h-20">
          ...
          <Link href="/" className="text-white hover:text-yellow-500 flex items-center">
      ...
      <section className="pb-16 md:pb-24">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16">
            <div className="bg-[#1a3246] rounded-2xl p-8 shadow-lg">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
            <div className="bg-[#1a3246] rounded-2xl overflow-hidden shadow-lg">
          ...
          {/* Why Choose Us */}
          <div className="bg-[#1a3246] rounded-2xl p-8 shadow-lg mb-16">
          ...
          <div className="text-center">
            ...
            <Link
              href="/therapy"
              className="inline-flex items-center justify-center bg-yellow-500 hover:bg-yellow-600 text-[#224058] px-8 py-4 font-bold rounded-xl text-lg"
            >
              Book a Therapy Sesh
            </Link>
          </div>
