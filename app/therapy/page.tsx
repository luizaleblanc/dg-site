    ...
    <main className="min-h-screen bg-[#224058] text-white">
      ...
      <header className="bg-[#224058] text-white border-b border-[#2d5170]">
        <div className="container mx-auto px-4 flex items-center justify-between h-20">
          ...
          <Link href="/apply" className="text-white hover:text-yellow-500 flex items-center">
      ...
      <section className="py-16 md:py-24">
        <div className="container mx-auto px-4">
          <div className="max-w-2xl mx-auto bg-[#1a3246] rounded-2xl p-8 shadow-lg">
            ...
            >
              <div>
                ...
                <input
                  ...
                  id="name"
                  name="name"
                  className="w-full px-4 py-2 bg-[#2d5170] border border-[#3d6180] rounded-xl focus:outline-none focus:ring-2 focus:ring-yellow-500"
              ...
              <Button
                type="submit"
                className="w-full bg-yellow-500 hover:bg-yellow-600 text-[#224058] py-3 font-bold rounded-xl"
              >
